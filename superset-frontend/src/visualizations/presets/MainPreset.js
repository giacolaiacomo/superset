...
import { AdvancedTableCommodities } from '../../../plugins/superset-plugin-viz-advanced-table/src';
...
export default class MainPreset extends Preset {
  constructor() {
    ...
    super({
      ...
      plugins: [
        new AdvancedTableCommodities().configure({ key: 'advanced-table-commodities' }),
