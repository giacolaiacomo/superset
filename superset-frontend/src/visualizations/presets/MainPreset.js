...
import { SupersetPluginVizAdvancedTable as AdvancedTablePlugin } from '../../../plugins/superset-plugin-viz-advanced-table/src';
...
export default class MainPreset extends Preset {
  constructor() {
    ...
    super({
      ...
      plugins: [
        new AdvancedTablePlugin().configure({ key: 'advanced_table' }),
